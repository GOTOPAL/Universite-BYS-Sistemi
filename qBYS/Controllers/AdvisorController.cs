...
public class AdvisorController : Controller
{
    ...
    public async Task<IActionResult> AdvisorPanel()
    {
        ...
        var response = await _httpClient.GetAsync($"https://localhost:7268/api/Advisors/{advisorId}");
        ...
        try
        {
            var responsee = await _httpClient.GetAsync($"https://localhost:7268/api/NonConfirmedSelections/Advisor/{advisorId}");
    ...
    public async Task<IActionResult> UpdateAdvisor(int id, string newEmail, string newPassword)
    {
        ...
        var advisorResponse = await _httpClient.GetAsync($"https://localhost:7268/api/Advisors/{id}");
        ...
        if (!string.IsNullOrEmpty(newEmail))
        {
            ...
            var updateAdvisorResponse = await _httpClient.PutAsync($"https://localhost:7268/api/Advisors/{id}", advisorJsonContent);
    ...
    public async Task<IActionResult> RejectCourse(int id)
    {
        try
        {
            ...
            var response = await _httpClient.DeleteAsync($"https://localhost:7268/api/NonConfirmedSelections/{id}");
    ...
    public async Task<IActionResult> ApproveCourse(int id, int studentID, int courseID)
    {
        try
        {
            ...
            var response = await _httpClient.PostAsync("https://localhost:7268/api/StudentCourseSelections", content);

            if (response.IsSuccessStatusCode)
            {
                // Onaylanan seçimi NonConfirmedSelections'dan sil
                await _httpClient.DeleteAsync($"https://localhost:7268/api/NonConfirmedSelections/{id}");
